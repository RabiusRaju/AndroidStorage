    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        internalStoragePhotoAdapter = InternalStoragePhotoAdapter {
            lifecycleScope.launch {
                ...
                if (isDeletionSuccessful) {
                    ...
                    Toast.makeText(this@MainActivity, "Failed to deleted photo", Toast.LENGTH_SHORT).show()
                }
            }
        ...
        intentSenderLauncher = registerForActivityResult(ActivityResultContracts.StartIntentSenderForResult()){
            if (it.resultCode == RESULT_OK){
                ...
                Toast.makeText(this, "Photo could not be deleted ", Toast.LENGTH_SHORT)
                    .show()
            }
        ...
        val takePhoto = registerForActivityResult(ActivityResultContracts.TakePicturePreview()) {
            ...
            lifecycleScope.launch {
                ...
                if (isSavedSuccessfully) {
                    ...
                    Toast.makeText(this@MainActivity, "Failed to saved photo", Toast.LENGTH_SHORT).show()
                }
            }
    ...
    private suspend fun loadPhotosFromExternalStorage(): List<SharedStoragePhoto> {
        return withContext(Dispatchers.IO) {
            ...
            contentResolver.query(
                ...
                val idColum = cursor.getColumnIndexOrThrow(MediaStore.Images.Media._ID)
